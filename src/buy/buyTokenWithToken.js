...
const tokenPuchaseContract = process.env.TOKEN_PURCHASE_CONTRACT;
...
const buyTokenWithToken = async () => {
  try {
    ...
    const amounts = await router.getAmountsOut(sellAmount, [tokenContract, tokenPuchaseContract]);
    ...
    ========================================================================================================
      ...
      ${chalkTransactionInfo('Quantidade mínima a receber:', chalkValue(formatEther(amountOutMin)), '-', chalkToken(tokenPuchaseContract), '(BNB)')}
    ========================================================================================================
    `);
    ...
    console.log(chalkTransactionInfo(`BNB: ${chalkToken(tokenPuchaseContract)} (BNB)`));
    ...
    const tx = await router.swapExactTokensForTokens(
      sellAmount,
      amountOutMin,
      [tokenContract, tokenPuchaseContract],
      address,
...
export default buyTokenWithToken;
